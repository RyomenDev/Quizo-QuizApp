...
import { ValidatePassword } from "./Validations.jsx";
...
const PasswordField = ({
  ...
  const passwordValidation = ValidatePassword(value); // Call validation function
...
PasswordField.propTypes = {
  ...
  Icon: PropTypes.node, // Accepting icon as a prop
};
